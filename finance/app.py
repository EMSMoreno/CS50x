...
def add_cash():
    ...
    if request.method == "GET":
        ...
        # UPDATE users SET cash = :uptd_cash WHERE id = :user_id
        db.execute("UPDATE users SET cash = :uptd_cash WHERE id = :user_id", uptd_cash=uptd_cash, user_id=user_id)
...
def sell():
    ...
    if request.method == "GET":
        ...
        db.execute("UPDATE users SET cash = :updated_cash WHERE id = :user_id", updated_cash=uptd_cash, user_id=user_id)
